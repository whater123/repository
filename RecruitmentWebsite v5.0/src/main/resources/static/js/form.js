...
if(arg>0&&arg<1000){
      ...
      $.ajax({
            type: "POST",
            contentType: "application/json",
            url: "http://182.61.16.76:8080/RecruitmentWebsite/manager/getStudentMsg/"+arg,
            dataType: 'text',
            timeout: 600000,
            success: function (data){
                let user = JSON.parse(data);
...
$(document).ready(function(){
        ...
        $.ajax({
            type: "POST",
            contentType: "application/json",
            url: "http://182.61.16.76:8080/RecruitmentWebsite/user/freshmanSignUp_normal",
...
$(document).ready(function(){
        ...
        $.ajax({
            type: "POST",
            contentType: "application/json",
            url: "http://182.61.16.76:8080/RecruitmentWebsite/user/freshmanSignUp_mogul",
            data: JSON.stringify(user),
            dataType: 'text',
            timeout: 600000,
            success: function (data){
