...
$(document).ready(function(){
        $("#show_all").click(function(){
          ...
          $.ajax({
            ...
            url: "http://182.61.16.76:8080/RecruitmentWebsite/manager/queryStudents",
          ...
          $.ajax({
            ...
            success: function (data){
                ...
                if(newIds[length].value!=user[p].id)
                {
                    ...
                    type: "POST",
                    contentType: "application/json",
                    url: "http://182.61.16.76:8080/RecruitmentWebsite/manager/editId",
                ...
                if(newState[length].value!=user[p].stageState)
                {
                    ...
                    type: "POST",
                    contentType: "application/json",
                    url: "http://182.61.16.76:8080/RecruitmentWebsite/manager/editStatus",
                    data: JSON.stringify(Obj),
                    dataType: 'text',
                    timeout: 600000,
                    success: function (data){
